...
import { DEEP_FOREST, EARTH_GREEN, GRANITE_GOLD, RIVER_ROCK, SIERRA_SKY, PARCHMENT, PARCHMENT_BORDER, RUST } from "../constants/colors";
...
export default function CreateTripModal({ visible, onClose, onTripCreated }: CreateTripModalProps) {
  ...
  const handleCreateTrip = async () => {
    ...
    try {
      ...
      setFormError("Something went wrong creating your trip. Please try again.");
    } finally {
